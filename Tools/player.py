...
def make_charicter(ctx, *args):
    try:
        ...
        info['Skills Expertise'] = info['Expertise']
        print("Skills",info['Skills Prof'])
        ...
        for a in info['Skills Prof'].split(','):
            if (a != '') and (a != '__') and (a != "__ "):
                skills[a.replace(' ','').lower()] += info['Proficiency']
        print("Skills Done")


        info['Skills Expertise'] += ','
        for a in info['Skills Expertise'].split(','):
            if (a != '') and (a != '__') and (a != "__ "):
                #print(a == '__ ')
                #print('"{}"'.format(a))
                skills[a.replace(' ','').lower()] += info['Proficiency']*2
