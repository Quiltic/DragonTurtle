...

{
    ...
    #"greatsword": {'To Hit': '1d20 + prof + str','Damage': '1d8 + str'},
...
#"""
"""
from Cogs.player import Character
from JTools import File, Load, Save
f = File("C:\\Users\\Quiltic\\Desktop\\Charicter")
#print([n for n in f.files])
for n in f.filepaths:
    name = n[n.index('_')+5:-4]
    
    print(name)
    
    n = Load(n[:-4])
    n["name"] = name.capitalize()
    tn = {}
    for a in n:
